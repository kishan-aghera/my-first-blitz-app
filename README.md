...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/my-first-blitz-app
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/my-first-blitz-app_test
```
